        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 md:gap-8 min-h-[300px]">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              ...
              <div className="absolute -top-3 -right-3 bg-indigo-500 text-white text-[8px] font-black px-2 py-1 rounded uppercase tracking-tighter">
                Gateway
              </div>
            </div>
            <div className="text-center">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 py-8">
          ...
          <div className="flex flex-col items-center gap-4 z-10">
            <div className="flex gap-4">
              <div className="px-3 py-1 bg-rose-500/10 text-rose-500 border border-rose-500/20 rounded text-[8px] font-black uppercase tracking-widest">
                Geçersiz 401
              </div>
              <div className="px-3 py-1 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 rounded text-[8px] font-black uppercase tracking-widest">
                Geçerli
              </div>
            </div>
