    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="px-6 py-3 bg-emerald-50 border border-emerald-100 rounded-2xl shadow-sm">
          ...
          <span className="text-xl font-black text-slate-900 tabular-nums leading-none mt-1 inline-block">{logs.length}</span>
        </div>
      </div>
      ...
      <div className="glass-panel border border-slate-200 rounded-[2rem] p-8 bg-white shadow-xl relative overflow-hidden">
        ...
        <h2 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-8 relative italic">SORGULAMA PARAMETRELERİ</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8 relative">
          {/* Limit */}
          <div className="space-y-2.5">
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">LİMİT</label>
            <input
              type="number"
              min="1"
              max="1000"
          ...
          {/* Start/Offset */}
          <div className="space-y-2.5">
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">KAYDIRMA (OFFSET)</label>
            <input
              type="number"
              min="0"
              value={start}
          ...
          {/* Order */}
          <div className="space-y-2.5">
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">SIRALAMA</label>
            <select
              value={order}
          ...
          {/* From Date */}
          <div className="space-y-2.5">
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">BAŞLANGIÇ TARİHİ</label>
            <input
              type="datetime-local"
              value={fromDate}
          ...
          {/* Until Date */}
          <div className="space-y-2.5">
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">BİTİŞ TARİHİ</label>
            <input
              type="datetime-local"
              value={untilDate}
      ...
      {error && (
        <div className="bg-rose-50 border border-rose-100 rounded-[2rem] p-6 flex items-start gap-4 animate-shake shadow-sm">
          ...
          <div>
            <p className="font-black text-rose-600 uppercase tracking-widest text-xs">Sorgu Hatası</p>
                ...
                <tr>
                  <td colSpan={4} className="px-8 py-20 text-center">
                    <div className="flex flex-col items-center justify-center gap-4">
                      ...
                      <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.4em]">VERİ AKIŞI DİNLENİYOR...</p>
                    </div>
                  </td>
                </tr>
              ) : (
                      ...
                      <td className="px-8 py-5 text-sm">
                        <span
                          className={cn(
                            ...
                            log.level === 'info' && 'bg-emerald-50 text-emerald-600 border-emerald-100',
